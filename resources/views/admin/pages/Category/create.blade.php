        ...
        <div class="page-bar">
            <div class="page-title-breadcrumb">
                ...
                <ol class="breadcrumb page-breadcrumb pull-right">
                    ...
                    <li>
                        <a class="parent-item" href="#">Add Categories</a>&nbsp;<i class="fa fa-angle-right"></i>
                    </li>
            ...
            <div class="col-md-12 col-sm-12">
                <div class="card card-box">
                    ...
                    <div class="card-body" id="bar-parent">
                        ...
                        <form action="{{URL::to('Category')}}" enctype="multipart/form-data" id="form_sample_1" class="form-horizontal" method="post">
                            @csrf
                                ...
                                <div class="form-actions">
                                    <div class="row">
                                        <div class="offset-md-3 col-md-9">
                                            ...
                                            <a class="btn btn-outline-primary" href="{{URL::to('Category')}}">CANCEL</a>
                                        </div>
                                    </div>
                                </div>
