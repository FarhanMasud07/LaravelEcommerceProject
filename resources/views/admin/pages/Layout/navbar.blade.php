...
<!-- Mirrored from radixtouch.in/templates/admin/smart/source/light/add_course.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 18 Oct 2019 23:14:42 GMT -->
<head>
	<meta charset="utf-8" />
				...
				<ul id="themecolors">
					...
					<li class="complete">
						<div class="theme-color layout-theme">
							...
							<a href="http://radixtouch.in/templates/admin/smart/source/dark/add_course.html" data-theme="dark"><span class="head"></span><span
									class="cont"></span></a>
						</div>
					</li>
					<li>
					...
					<div id="remove-scroll" class="left-sidemenu">
						<ul class="sidemenu  page-header-fixed slimscroll-style" data-keep-expanded="false"
							...
							<li class="sidebar-user-panel">
								<div class="user-panel">
									<div class="pull-left image">
										<img src="{{'Admin/assets/img/dp.jpg'}}" class="img-circle user-img-circle"
											alt="User Image" />
									</div>
							...
							<li class="nav-item start ">
								...
								<ul class="sub-menu">
									<li class="nav-item   ">
										<a href="{{URL::to('administration')}}" class="nav-link ">
