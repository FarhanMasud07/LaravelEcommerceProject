  ...
  <div class="row">
    ...
    <div class="col-lg-3 col-md-4 col-sm-6">
      <div class="product-card mb-30">
        ...
        @if($i>0)
        <a class="product-thumb" href="{{URL::to('product/'.$product->slug)}}"><img style="height:200px;width:200px;" src="{{asset('upload/productspic/'.$image->image)}}" alt="Product"></a>
        @endif
        ...
        <div class="product-card-body">
          ...
          <h3 class="product-title"><a href="{{URL::to('product/'.$product->slug)}}">{{$product->title}}</a></h3>
